...
| **Handlungsempfehlung** | **Lokales LLM via Ollama** (**Llama 3.2 3B**), Output über **Ollama Structured Outputs** (JSON-Schema) | DSGVO-konform lokal, kein Cloud-Datenabfluss; 3B genügt, da das Format ohnehin erzwungen wird; strukturierter Output für reproduzierbare Empfehlungs-Karten. |
